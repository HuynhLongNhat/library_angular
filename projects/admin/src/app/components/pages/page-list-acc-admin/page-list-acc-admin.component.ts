...
@Component({
  selector: 'app-page-list-acc-admin',
  template: `
                    ...
                    <form id="newForm">
                      <div class="mb-3">
                        <label for="name" class="form-label"
                          ><span style="color: red;">* </span>Mã nhân
                          viên</label
                        >
                        <input
                          type="text"
                      ...
                      <div class="mb-3">
                        <label class="form-label"><span style="color: red;">* </span>Họ tên nhân viên</label>
                        <input type="text" class="form-control" required />
                      </div>
                      <div class="mb-3">
                        <label class="form-label"><span style="color: red;">* </span>Mật khẩu</label>
